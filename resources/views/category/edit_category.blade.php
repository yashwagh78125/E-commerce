						...
						<div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
									...
									<div class="mb-3">
                                        <label for="catimage">products Image</label><br>
                                        <input type="file"  class="border border-1 border-secondary"name="image" id="image" ><br>
                                        <img src="{{"/catimage/$category->image"}}" alt="" height="50px" width="50px">
                                    </div>  
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                        <label for="status">Status</label>
                                        <select name="status" id="cars" class="form-control"  value="{{$category->status}}">
