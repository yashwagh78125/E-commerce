                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="description" cols="30" rows="10"  class="form-control"  placeholder="Description" style="height: 200px"> </textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="file"  class="border border-1 border-secondary"name="image" id="image" >
                                    </div>  
                                    <div class="mb-3">
                                        <label for="image">Multiple Images</label><br>
                                        <input type="file"  class="border border-1 border-secondary" name="images[]" id="images" multiple>
                                    </div>  
                                </div>
                            </div>
                            <div class="card mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="offerprice" id="offerPrice"  class="form-control" placeholder="Price" readonly required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
