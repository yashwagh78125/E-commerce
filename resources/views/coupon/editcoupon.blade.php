								...
								<div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="max_uses_user" id="max_uses_user" class="form-control"  value="{{$coupon->max_uses_user}}">
										</div>
									</div>	
									<div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="status">Type</label>
                                            <select name="type" id="type" class="form-control" value="{{$coupon->type}}">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="minimum_amount" id="minimum_amount" class="form-control" value="{{$coupon->min_amount}}" >
										</div>
									</div>	
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                        <label for="status">Status</label>
                                        <select name="status" id="status" class="form-control" value="{{$coupon->status}}">
                                      ...
                                      <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="date"name="starts_at" id="starts_at" class="form-control" placeholder="Slug" value="{{$coupon->starts_at}}">
										</div>
									</div>	
                                     <div class="col-md-6">
										<div class="mb-3">
											<label for="slug">Expire At </label>
											<input type="date" name="expire_at" id="expire_at" class="form-control" placeholder="Slug" value="{{$coupon->expires_at}}">
										</div>
									</div>	
                                     <div class="col-md-6">
										<div class="mb-3">
											<label for="slug">Discription</label>
											<textarea name="Discription" id="Discription" class="form-control" >{{$coupon->description}}</textarea>
										</div>
									</div>	
