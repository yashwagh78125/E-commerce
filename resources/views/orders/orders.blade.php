					...
					<div class="container-fluid">
						<div class="card">
								...
								<table class="table table-hover text-nowrap"  >
									...
									<tbody>
										...
										<tr>
											...
											<td>{{$details->street}},{{$details->city}},{{$details->state}},{{$details->country}}</td>
											<td>{{$details->mobno}}</td>
                                            <td>{{$details->email}}</td>
                                            <td>{{$details->order_note}}</td>
											<td><a href="{{route('showOrderItems.show',$details->order_id)}}" class="text-primary">View</a></td>
											{{-- <td>
												...
												<a href="{{route('coupon.destroy',$coupon->id)}}" class="text-danger w-4 h-4 mr-1">
							...
							<div class="card-footer clearfix">
								{{-- {{$suballcategory->links('pagination::bootstrap-5')}} --}}
