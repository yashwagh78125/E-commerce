                ...
                <div
                    ...
                    <div class="col-auto mb-6">
                        <div class="footer-payment">
                            <div class="image">
                                <img src="{{asset('website/images/company-logo/payment.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="{{asset('website/js/vendor/jquery-3.5.1.min.js')}}"></script>
...
<script src="{{asset('website/js/vendor/jquery-ui.min.js')}}"></script>

<!--Plugins JS-->
<script src="{{asset('website/js/plugins/swiper-bundle.min.js')}}"></script>
<script src="{{asset('website/js/plugins/material-scrolltop.js')}}"></script>
<script src="{{asset('website/js/plugins/jquery.nice-select.min.js')}}"></script>
<script src="{{asset('website/js/plugins/jquery.zoom.min.js')}}"></script>
<script src="{{asset('website/js/plugins/venobox.min.js')}}"></script>
<script src="{{asset('website/js/plugins/jquery.waypoints.js')}}"></script>
<script src="{{asset('website/js/plugins/jquery.lineProgressbar.js')}}"></script>
<script src="{{asset('website/js/plugins/aos.min.js')}}"></script>
<script src="{{asset('website/js/plugins/jquery.instagramFeed.js')}}"></script>
